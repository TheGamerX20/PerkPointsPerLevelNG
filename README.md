# PerkPointsPerLevel NG

PerkPointsPerLevel remade for FO4 1.10.984.0.
...
## Getting Started
```bat
git clone --recurse-submodules https://github.com/TheGamerX20/PerkPointsPerLevelNG
cd PerkPointsPerLevelNG
```
